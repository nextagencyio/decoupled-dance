...
import performancesData from '@/data/mock/performances.json'
...
const mockDataMap: Record<string, any> = {
  ...
  'performances.json': performancesData,
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetPerformances') || query.includes('nodePerformances')) {
      return loadMockData('performances.json')
    }
