...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Class Not Found | Dance' }
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  {(item as any).danceStyle && (
                    <div>
                      <dt className="text-sm text-gray-500">Dance Style</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).danceStyle}</dd>
                    </div>
                  )}
