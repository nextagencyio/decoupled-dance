...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  const title = (homepageContent as any)?.heroTitle || (homepageContent as any)?.title || 'Feel the Rhythm, Own the Stage!'
  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white py-24 md:py-36 overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=1920&q=80&fit=crop)' }}
      />
      ...
      <div className="absolute bottom-32 right-[15%] w-16 h-16 bg-purple-400 rounded-full opacity-50 animate-bounce" style={{ animationDelay: '1s', animationDuration: '4s' }} />
      <div className="absolute top-40 right-[25%] w-12 h-12 bg-accent-300 rounded-2xl opacity-50 rotate-45 animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '3.5s' }} />
